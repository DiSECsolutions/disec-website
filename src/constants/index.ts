export const SITE_CONFIG = {
  ...
  contactEmail: "gauthamceo@disecsolution.com",
  contactPhone: "+91 83 300 89 379",
  address: "DiSEC Intelligence Center, Outer Ring Road, Bengaluru, Karnataka, India",
};
